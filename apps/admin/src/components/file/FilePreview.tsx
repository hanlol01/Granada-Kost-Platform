...
export function FilePreview({ file, size = 64, onClick, className }: FilePreviewProps) {
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={
        "group relative flex items-center justify-center overflow-hidden rounded-lg border border-border bg-muted transition-colors hover:border-primary/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring " +
