...
export function WhatsAppFallbackButton({
  ...
  return (
    <a
      ...
      className={
        "inline-flex h-10 items-center justify-center gap-2 rounded-xl bg-green-600 px-4 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-green-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 " +
        (className ?? "")
      }
    >
