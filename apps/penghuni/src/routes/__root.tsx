    ...
    links: [
      {
        rel: "icon",
        type: "image/png",
        href: "/images/brand/kostation-mark.png",
      },
      {
        rel: "stylesheet",
        href: appCss,
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try { document.documentElement.classList.toggle('dark', window.localStorage.getItem('theme') !== 'light'); } catch { document.documentElement.classList.add('dark'); }",
          }}
        />
        <HeadContent />
      </head>
