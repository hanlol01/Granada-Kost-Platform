...
function serviceHarness(options: Options = {}) {
  ...
  const snapshot = {
    ...
    snapshot_commercial_effective_date: '2026-10-01',
    snapshot_reference_monthly_price: 1_500_000,
    pricing_source: 'standard',
    pricing_agreement_reason: null,
    pricing_agreed_by_user_id: USER_ID,
    pricing_agreed_at: '2026-08-01T00:00:00Z',
    room_number: 'A-01',
