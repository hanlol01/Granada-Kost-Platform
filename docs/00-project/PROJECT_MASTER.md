...
- **Rekomendasi berikutnya: M18 - Public Hunian Catalog Detail / Modern Listing** - desain katalog publik modern; halaman detail level hunian/unit (BUKAN nomor kamar eksak); foto/galeri; fasilitas; peraturan/kebijakan; penjelasan harga; FAQ; SEO/public copy; CTA WhatsApp/lead; tanpa payment gateway booking. Jalur alternatif tetap valid tergantung keputusan produk: production hardening, Smart Lock real site trial (M13F-C5), payment production activation readiness (Midtrans production keys backend-only, notification URL production, QA payment production, checklist deployment production, dan approval stakeholder), atau CCTV planning. Independen dari jalur yang dipilih: jadwalkan browser visual QA (M16C/M16E/M17C/M17D) saat tooling browser tersedia.
