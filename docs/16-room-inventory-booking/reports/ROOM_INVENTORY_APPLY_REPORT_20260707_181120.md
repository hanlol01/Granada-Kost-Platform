...
> **Run timestamp**: 2026-07-07 18:11:20 Asia/Jakarta
> **Mode**: apply
...
- PASS - --apply flag present: required for write mode
...
- PASS - Safe backfill state: pre_backfill
...
- PASS - Explicit import confirmation: ROOM_INVENTORY_IMPORT_CONFIRM must equal APPLY_M16_ROOM_INVENTORY
- PASS - Backup confirmation: ROOM_INVENTORY_BACKUP_CONFIRMED must equal true

Backup confirmation status: confirmed
...
| rooms updated | 163 |
| post-apply room count | 163 |
| post-apply room_buildings count | 26 |
