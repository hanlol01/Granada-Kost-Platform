...
| `POL-BILLING-002` | Ordinary direct onboarding supports a minimum term of three months. The current form offers 3, 6, and 12-month shortcuts and accepts an integer term from 3 through 120 months. Contract rent is the selected duration-tier monthly rate multiplied by the complete term; 13 months therefore uses the 12+ rate for all 13 months. |
