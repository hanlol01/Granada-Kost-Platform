...
| Correct account and property boundaries                     | `DEC-AUTH-001`, `DEC-PROPERTY-001`, `INV-AUTH-001..002`, `INV-PROPERTY-001`                                                                                       | `FR-ADM-AUTH-001`, `FR-ADM-AUTH-101`, `FR-ADM-PROPERTY-001`, `FR-ADM-PROPERTY-101`; all `FR-PEN-AUTH-*`; all `FR-POW-AUTH-*`               | Authentication, authorization, account provisioning, and authenticated effective asset scope                                  | `KMO-W00`, `KMO-W01`, `KMO-W04`, `KMO-W10`, `KMO-W11` | `QA-AUTH-001`, `QA-PROPERTY-001`, `QA-PENGHUNI-001`, `QA-OWNER-001`               | APPROVED |
...
| Property Owner receives read-only mixed-asset evidence      | `DEC-OWNER-001..010`, `INV-OWNER-001`                                                                                                                             | `FR-ADM-OWNER-101`; `FR-POW-OWNER-001..003`, `FR-POW-OWNER-101..105`; all supporting `FR-POW-*`                                            | Owner Profile/account, effective Rumah Kost building and Apart Kost room history, read-only projections, period-bound exports | `KMO-W10-OWNER-A..D`                                  | `QA-OWNER-001`, `QA-PROPERTY-001`, `QA-REPORT-001..005`                           | APPROVED |
| Earned rent becomes reviewable Owner entitlement and payout | `DEC-OWNER-005..010`, `INV-OWNER-001`, `INV-PAYMENT-001..003`                                                                                                     | `FR-ADM-OWNER-101`; `FR-POW-BILLING-101`, `FR-POW-PAYMENT-101`, `FR-POW-REPORT-101..106`                                                   | Collected-and-earned attribution, effective policy snapshot, monthly settlement, adjustment, approval, and payout             | `KMO-W10-OWNER-A`, `KMO-W10-OWNER-C..D`               | `QA-OWNER-001`, `QA-PAYMENT-001..006`, `QA-REPORT-001..005`                       | APPROVED |
...
| Property Owner                | all `FR-POW-*`                                               | `KMO-W10-OWNER-A..D`                                  | Effective Rumah Kost-building and Apart Kost-room projections, period-bound reports/settlements, empty-scope behavior, and rejection of all operational writes. |
...
| Settle a contract balance or record arrears        | `POL-SETTLEMENT-001..004`, `INV-BILLING-001..002` | `KMO-W07A`             | Contract settlement, first-payment checkpoint, deadline, and allocation contracts |
| Start/administer arrears termination safely        | `POL-TERMINATION-001`, `POL-DEPOSIT-010`          | `KMO-W07A`             | Admin-only, transaction, deposit-offset/refund, and no-auto-checkout contracts    |
| Complete general checkout and deposit disposition | `POL-PAYMENT-006`, `INV-LEASE-001..002`           | `KMO-W07D`             | Admin-only checkout command, evidence gates, W06-backed invoice credit, append-only deposit, parking release, inspection room result, and weekday refund-due contracts |
...
| Add mixed-asset ownership and Owner financial history  | `INV-OWNER-001`, `INV-PROPERTY-001`, `INV-PAYMENT-001..003` | `KMO-W10-OWNER-A..D` | Rumah Kost building and Apart Kost room periods do not overlap; unassigned assets are Kostation-owned; entitlement and payout reconcile to earned verified rent. |
...
database application. It does not override the package-specific delivery status
in section 10: W07A remains `SOURCE_IMPLEMENTED; AUTOMATED REVIEW PENDING;
RUNTIME DEFERRED`, while W07B–D, W08, W09, W11, and W12 remain planned.
...
| `KMO-W02B`                                  | Category Kost Type is the sole effective-dated commercial authority for tariff, read-only 25% initial-rent-credit policy, payment schedules, and facility reads; room and lease consumers use its current version                                                                                                                                                              | [KMO-W02B_CATEGORY_COMMERCIAL.md](evidence/KMO-W02B_CATEGORY_COMMERCIAL.md), disposable first-apply/replay proof, focused backend/Admin contracts, and relevant W02A/M10/M13–M15 regressions                                                                                                                                                                                                                | AUTOMATED_VERIFIED; RUNTIME_DEFERRED             |
...
| `KMO-W03-PUBLIC`                            | Published category catalog, category/gender discovery, strict public projection, and non-binding short booking lead without exact-room authority                                                                                                                                                                                                                               | [KMO-W03_PUBLIC_CATALOG_BOOKING_LEAD.md](evidence/KMO-W03_PUBLIC_CATALOG_BOOKING_LEAD.md), focused backend/Penghuni contracts, and relevant publication/lead regressions                                                                                                                                                                                                                                    | AUTOMATED_VERIFIED; RUNTIME_DEFERRED             |
| `KMO-W03-ADMIN`                             | Property-scoped Admin booking-lead queue, safe manual quick entry, hold-aware lead action, and authoritative status workspace                                                                                                                                                                                                                                                  | Focused Admin/API contracts, M11/M14 compatibility tests, and commit `6925c830`                                                                                                                                                                                                                                                                                                                             | AUTOMATED_VERIFIED; RUNTIME_DEFERRED             |
| `KMO-W04`                                   | Resident identity, property membership, account provisioning, and one-time credential receipt without lease/occupancy mutation                                                                                                                                                                                                                                                 | Focused Admin/API contracts, M18 boundary regressions, migration proof, and commit `49b06e68`                                                                                                                                                                                                                                                                                                               | AUTOMATED_VERIFIED; RUNTIME_DEFERRED             |
| `KMO-W05`                                   | Direct/lead onboarding commitment, 3–120 month terms, Booking Fee/DP initial-credit gate, optional deposit, and separate lease activation                                                                                                                                                                                                                                      | Focused Admin/API lifecycle contracts, migration proof, and commit `a6dc5395`                                                                                                                                                                                                                                                                                                                               | AUTOMATED_VERIFIED; RUNTIME_DEFERRED             |
| `KMO-W06`                                   | Manual payment ledger, proof/verification/reversal workflow, invoice allocation, Booking Fee/DP rent credit, and deposit-liability separation                                                                                                                                                                                                                                  | Focused Admin/Penghuni/API contracts, migration proof, and commit `40b820d3`                                                                                                                                                                                                                                                                                                                                | AUTOMATED_VERIFIED; RUNTIME_DEFERRED             |
| `KMO-W03/W05/W06 Lead-completion amendment` | Hold-gated lead completion, one immutable Lead Payment Commitment, authoritative `/tenants` prefill/re-quote before Commit Onboarding, and one-time W06/deposit materialization                                                                                                                                                                                                | Focused Admin/API lead-completion, hold, public catalog, quote, and onboarding contracts; migration `029` manifest-registered                                                                                                                                                                                                                                                                               | SOURCE_IMPLEMENTED; CANONICAL_MIGRATION_DEFERRED |
| `KMO-W10-OWNER-A3 / C / D`                  | Additive 037 allocation-backed exact half-open earning service coverage; active rent allocation/invoice/lease/occupancy reconciliation; coverage-bound settlement/adjustment/payout and financial notification lineage; clipped historical projections; embedded-Unicode `property_owner` read-only portal/report/export; explicit reconciliation and runtime/rollback runbook | Focused W10 authority/portal contracts, real Type0/CID/ToUnicode PDF text extraction plus XLSX detail extraction, Admin strict parser/navigation/state contracts, API/Admin build, and disposable PostgreSQL first-apply/replay/allocation/lifecycle/constraint/rollback/cleanup plus allocation-to-earning/settlement/payout reconciliation proof; canonical migration and browser/runtime remain deferred | AUTOMATED_VERIFIED; RUNTIME DEFERRED             |

Aggregate status: `KMO-W00–W06 — AUTOMATED VERIFIED; RUNTIME DEFERRED. KMO-W10-OWNER-A3–D — AUTOMATED VERIFIED; RUNTIME DEFERRED`.
...
not runtime or product evidence. W03 through W06 have focused automated evidence;
runtime/browser proof remains deferred. W10-OWNER-A3–D has focused automated and
