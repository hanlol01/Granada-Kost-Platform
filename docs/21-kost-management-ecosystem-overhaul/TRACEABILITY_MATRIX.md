...
Aggregate status: `KMO-W00–W06 — AUTOMATED VERIFIED; RUNTIME DEFERRED`.
...
runtime/browser proof remains deferred. W07 onward is still planned and is not
advanced by these delivery rows.
