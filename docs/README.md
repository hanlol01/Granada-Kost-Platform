...
| `14-production-readiness/` | Production readiness / internal demo refresh (M14): `PRODUCTION_READINESS_AUDIT.md` (M14A audit — readiness levels pasca M12+M13, feature readiness matrix, klarifikasi status Smart Lock — execution pending, production blockers, scope demo internal, QA track M14B–M14F, deployment/env checklist, documentation gaps, risk register; dokumentasi saja, tanpa validasi terminal) |
